...
stable public names without depending on internal file layout. The 214
...
|---|---|---|
| [bayes](bayes.md) | 6 | Hypothesis-data model comparison via `predict` / `compare` plus `PrecomputedLikelihoods` for external-solver wrappers. Distribution factories live at `lang`. |
...
**Grand total: 214 symbols across 7 facades.**
